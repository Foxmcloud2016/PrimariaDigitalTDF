...
from .views import DispositivosView, EscuelaDispositivosView, CreateAdm, DispositivoCreateView,NetbookCreateView


urlpatterns = [
    url(r'^alta/dispositivo/netbooks/(?P<id_adm>[0-9]+)/',NetbookCreateView.as_view(),name='alta_netbook'),
