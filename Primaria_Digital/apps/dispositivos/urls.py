...
from .views import DispositivosView, EscuelaDispositivosView, CreateAdm, DispositivoCreateView


urlpatterns = [
    #url(r'^alta/dispositivo/(?P<id_adm>[0-9]+)-(?P<n_tipo>[0-9]+)/',NetbookCreateView.as_view(),name='alta_netbook'),
